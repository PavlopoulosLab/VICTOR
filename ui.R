ui <- fluidPage(
  ...
  navbarPage("", id = "navBar", selected = "Home",
             ...
             tabPanel("File Handling",
                      sidebarLayout(
                        sidebarPanel(
                          fileInput("inFiles", "Upload Multiple Cluster Set Files (each < 1MB)", accept = c(".tsv", ".txt"), multiple = TRUE),
             ...
             tabPanel("Compare Cluster Sets",
                      sidebarLayout(
                        sidebarPanel(
                          pickerInput("metrics", "Choose Metrics to Calculate:", # metrics selection
             ...
             tabPanel("Conductance",
                      sidebarLayout(
                        sidebarPanel(
                          ...
                          radioButtons("condDataType", "Choose raw or filtered cluster sets to calculate Conductance:",
                                       choices = c("Raw" = "raw",
                                                   "Filtered" = "filtered"),
             ...
             tabPanel("Help", tabsetPanel(id = "hTabs", 
                                          ...
                                          tabPanel("The Compare Cluster Sets Tab", div(id='help_clusterings')),
